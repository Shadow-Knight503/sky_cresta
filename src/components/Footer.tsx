...
const Footer = forwardRef((_props, ref: Ref<HTMLDivElement>) => {
    ...
    return (
        <footer ref={ref} className="w-screen flex bg-black mt-12">
            <div className="basis-1/2 grow p-12 text-white text-justify text-lg">
                ...
                <button className="bg-accn text-prim font-bold mt-2 p-2 rounded-lg float-right">Request Consultation Form</button>
            ...
            <iframe className="hidden md:block basis-1/4 lg:basis-1/2 w-full"
